...
# GGA
gga_graphs[2].append(load(subdir_objects+"karate_k=2_graph"));
gga_graphs[4].append(load(subdir_objects+"karate_k=4_graph"));
gga_graphs[5].append(load(subdir_objects+"karate_k=5_graph"));
